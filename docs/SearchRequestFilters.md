...
**After** | Pointer to **string** | Filter for results published/updated after this date. Must be in ISO 8601 format (YYYY-MM-DD). | [optional] 
**Before** | Pointer to **string** | Filter for results published/updated before this date. Must be in ISO 8601 format (YYYY-MM-DD). | [optional] 
